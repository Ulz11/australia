...
export default async function ShiftPage() {
  ...
  return (
    <>
      <Header title="My shift" />
      <Page>
        {live.length === 0 ? <Empty><div className="font-extrabold text-ink text-xl mb-2">No shift booked</div><Link href="/worker/explore" className="btn-primary">See what's near me</Link></Empty> :
