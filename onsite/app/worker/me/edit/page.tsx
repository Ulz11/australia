...
export default async function EditProfile() {
  ...
  return (
    <>
      <Header title={t("Edit profile")} back="/worker/me" />
      <Page>
        <Section title={t("My profile")} hint={t("This is what a boss sees before he books you. Your visa and card numbers stay private.")} />
