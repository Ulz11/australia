    ...
    <main className="max-w-md mx-auto p-6 pb-16 space-y-6 text-lg leading-snug">
      ...
      <Section title="What we collect">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Numbers you add to your <b>crew list</b>: the mobile number and the name you typed with it, if any. <b>Only you see them.</b> If nobody signs up with a number, we delete it 90 days after you added it. If they do sign up, we keep the record that you brought them, which is what keeps you from ever being charged an introduction fee for them.</li>
